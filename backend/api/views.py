...
class ShoppingCartViewSet(mixins.CreateModelMixin,
    ...
    def download_shopping_cart(request):
        ...
        shopping_cart = Recipe.recipe_ingredients.rel.related_model.objects.filter(
...
# from .filters import RecipeFilter  # ваш фильтр для рецептов
# from .mixins import CustomListRecipeDeleteMixin  # ваш миксин для списка и удаления
# from .pagination import CustomPagination  # ваша пагинация
# from .permissions import IsAuthorOrAdminOrReadOnly  # ваша кастомная проверка прав
# from .serializers import (
#     FavoriteRecipeSerializer,
#     IngredientSerializer,
#     RecipeCRUDSerializer,
